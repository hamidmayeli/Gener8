...
namespace FromModel
{
    ...
    private const string FlattenPrefixEnumSource =
        @"// <auto-generated/>
namespace FromModel
{
    ...
    private enum FlattenPrefixMode { Parent = 0, None = 1, Gapped = 2 }
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput(ctx =>
        {
            ...
            ctx.AddSource("FlattenPrefix.g.cs", SourceText.From(FlattenPrefixEnumSource, Encoding.UTF8));
        });
                ...
                if (prop.Type is INamedTypeSymbol nestedType)
                    foreach (var nested in GetModelProperties(nestedType, includeInherited: false))
                    {
                        var nestedName = flattenPrefix switch
                        {
                            ...
                            FlattenPrefixMode.Gapped => prop.Name + "_" + nested.Name,
                            _ => null
                        };
