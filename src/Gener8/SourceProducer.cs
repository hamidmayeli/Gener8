        ...
        foreach (var prop in target.Properties)
        {
            ...
            var dtoRead = prop.TypeData.HasTypeMapping
                ? prop.TypeData.HasGenericTypeMapping
                    ? BuildProjectedCollectionMapping($"dto.{prop.Name}", "ToModel", prop.TypeData.Type.EndsWith("?"))
            ...
            else
            {
                ...
                else
                {
                    rhs = prop.TypeData.HasTypeMapping
                        ? prop.TypeData.HasGenericTypeMapping
                            ? BuildProjectedCollectionMapping($"model.{modelPropName}", "ToDto", prop.TypeData.Type.EndsWith("?"))
