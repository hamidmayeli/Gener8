...
internal partial record DefaultSource(string Name, string Code, string Filename)
{
    ...
    public static readonly DefaultSource IgnoreTypeMappingAttribute = new(
        Name: "Gener8.IgnoreTypeMappingAttribute",
        Code: """
        // <auto-generated/>
        namespace Gener8;
        ...
        """,
        Filename: "IgnoreTypeMappingAttribute.g.cs"
    );
